        ...
        <tr><xsl:attribute name="id"><xsl:value-of select="//blockID" />_section</xsl:attribute>
          <td colspan="2">
				<table width="100%" cellspacing="5" cellpadding="0">
				  <tr>
					<td colspan="2" style="padding-left:10px; padding-right:10px"><xsl:value-of select="//content" disable-output-escaping="yes" /></td>
				  </tr>
				  <tr>
					<td colspan="2"><hr width="96%" align="center" size="1" /></td>
				  </tr>
				  <tr>
					<td align="right" colspan="2" style="padding-left:10px; padding-right:10px">
						<a href="#"><xsl:attribute name="onClick">editContent(<xsl:value-of select="//blockID" />)</xsl:attribute>edit content</a>
					</td>
				  </tr>
				</table>
		  </td>
