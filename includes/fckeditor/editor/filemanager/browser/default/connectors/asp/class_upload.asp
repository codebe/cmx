...
Class NetRube_Upload
	...
	Private Sub Class_Initialize
		...
		Set oSourceData		= Server.CreateObject("CMX_ADODB.Stream")
		oSourceData.Type	= 1
		oSourceData.Mode	= 3
		oSourceData.Open
	End Sub
	...
	Public Sub GetData
		...
		Set oFormStream = Server.CreateObject("CMX_ADODB.Stream")
	...
	Public Sub SaveAs(sItem, sFileName)
		...
		Dim oFileStream
		Set oFileStream = Server.CreateObject("CMX_ADODB.Stream")
		With oFileStream
			.Type		= 1
			.Mode		= 3
			.Open
