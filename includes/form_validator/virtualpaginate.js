...
menu[1]="Rumah Yang Dipohon"
menu[2]="Keterangan Mengenai Pemohon"
menu[3]="Pekerjaan"
menu[4]="Pendapatan Bulanan"
menu[5]="Tanggungan"
menu[6]="Kediaman Sekarang"
menu[7]="Pemilikan Harta"
menu[8]="Cara Bayaran"

for (var i=0; i<num; i++)
//flatviewhtml+='<a href="#flatview" rel="'+i+'">'+(i+1)+'</a> ' //build sequential pagination links
flatviewhtml+='<table border=1 width=20%><tr><td><a href="#flatview" rel="'+i+'">'+menu[i+1]+'</a></td></tr></table>'
